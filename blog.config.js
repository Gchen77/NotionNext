...
const BLOG = {
  ...
  APPEARANCE_DARK_TIME: process.env.NEXT_PUBLIC_APPEARANCE_DARK_TIME || [19, 8], // 夜间模式起至时间，false时关闭根据时间自动切换夜间模式
  ...
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://gchen.tech', // 网站地址
